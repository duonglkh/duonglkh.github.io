...
const extensions = defineCollection({
  loader: glob({ pattern: '**/*.yaml', base: './src/content/extensions' }),
  schema: z.object({
    title: z.string(),
...
const tokenTools = defineCollection({
  loader: glob({ pattern: '**/*.yaml', base: './src/content/token-tools' }),
  schema: z.object({
    title: z.string(),
    description: z.string(),
    repoUrl: z.string().url().optional(),
...
const shorts = defineCollection({
  loader: glob({ pattern: '**/*.yaml', base: './src/content/shorts' }),
  schema: z.object({
    title: z.string(),
    description: z.string(),
    repoUrl: z.string().url().optional(),
